...
describe('DateUtilsService', () => {
  ...
  it('#getAllDaysInPeriodOfTime should return 15 dates for period from 2022-11-01 to 2022-11-15', () => {
    const result = service.getAllDaysInPeriodOfTime(
      new Date(2022, 10, 1),
      new Date(2022, 10, 15),
    );
  ...
  it('#getLastDayOfTheMonth should return 2023-03-31', () => {
    const result = service.getLastDayOfTheMonth(
      new Date(2023, 2, 7, 0, 0, 0, 0),
    );
